...
describe('BulkActionsToolbar', () => {
  ...
  it('calls onBulkExport when export button is clicked', () => {
    ...
    render(<BulkActionsToolbar {...defaultProps} onBulkExport={onBulkExport} />)
  ...
  it('calls onBulkEditDestination when edit destination button is clicked', () => {
    ...
    render(<BulkActionsToolbar {...defaultProps} onBulkEditDestination={onBulkEditDestination} />)
  ...
  it('closes mobile dropdown after action is selected', async () => {
    const onBulkExport = vi.fn()
    const { findAllByText, queryAllByText } = render(<BulkActionsToolbar {...defaultProps} onBulkExport={onBulkExport} />)
