        ...
        >
          ...
          <div className="p-6 border-b border-gray-200 dark:border-gray-700">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              ...
              <select
                ...
                onChange={(e) =>
                  setSelectedCategory(
                    e.target.value as ShortcutCategory | 'all'
                  )
                }
              ...
              >
                <option value="all">
                  {t('shortcuts.allCategories') || 'All Categories'}
                </option>
            ...
            <div className="mt-3 text-sm text-gray-500 dark:text-gray-400">
              {isMac() ? (
                <span>
                  💡 {t('shortcuts.macInfo') || 'Showing shortcuts for macOS'}
                </span>
              ) : (
                <span>
                  💡{' '}
                  {t('shortcuts.windowsInfo') ||
          ...
          <div className="p-4 border-t border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900/50">
            <div className="flex items-center justify-between text-sm text-gray-600 dark:text-gray-400">
              <span>
                {t('shortcuts.showing') || 'Showing'} {filteredShortcuts.length}{' '}
                {t('shortcuts.shortcuts') || 'shortcuts'}
              </span>
