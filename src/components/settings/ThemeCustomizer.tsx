...
export function ThemeCustomizer() {
  ...
  const [activeTab, setActiveTab] = useState<
    'presets' | 'colors' | 'typography' | 'layout' | 'share'
  >('presets');
          ...
          <div className="space-y-6">
            ...
            <div className="p-4 border border-gray-300 dark:border-gray-600 rounded-lg bg-gray-50 dark:bg-gray-800">
              ...
              <div style={{ fontFamily: currentTheme.fonts.family }}>
                <p style={{ fontSize: currentTheme.fonts.size.sm }}>
                  Small text sample
                </p>
                <p style={{ fontSize: currentTheme.fonts.size.base }}>
                  Base text sample
                </p>
                <p style={{ fontSize: currentTheme.fonts.size.lg }}>
                  Large text sample
                </p>
                <p style={{ fontSize: currentTheme.fonts.size.xl }}>
                  Extra large text sample
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-3">
              ...
              <div className="grid grid-cols-3 gap-3">
                {(['compact', 'comfortable', 'spacious'] as ThemeDensity[]).map(
                  (density) => (
                    <button
                      key={density}
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                ...
                <button
                  onClick={() =>
                    updateAnimations({
                      enabled: !currentTheme.animations.enabled,
                    })
                  }
                  className={`
            ...
            {currentTheme.animations.enabled && (
              <div className="space-y-3">
                ...
                <div className="grid grid-cols-3 gap-3">
                  {(['slow', 'normal', 'fast'] as AnimationSpeed[]).map(
                    (speed) => (
                      <button
                        key={speed}
