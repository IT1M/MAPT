  ...
  const features = [
    {
      ...
      description:
        t('auth.branding.feature1Desc') ||
        'Track inventory with AI-powered insights',
    },
    {
      icon: '🔒',
      title: t('auth.branding.feature2Title') || 'Secure & Reliable',
      description:
        t('auth.branding.feature2Desc') ||
        ...
        <div className="space-y-6 mt-16">
          ...
          <p className="text-teal-100 text-lg">
            {t('auth.branding.subheadline') ||
              'Powerful tools for tracking, analyzing, and optimizing your inventory operations'}
          </p>
          ...
          <div className="space-y-4 mt-12">
            {features.map((feature, index) => (
              <div
                key={index}
                className="flex items-start gap-4 p-4 bg-white/10 backdrop-blur-sm rounded-lg"
              >
