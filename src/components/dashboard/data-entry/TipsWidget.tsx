...
const tips = [
  {
    ...
    description:
      'Use Ctrl+N to quickly start a new entry and Ctrl+S to save your work.',
    icon: (
      <svg
        className="w-6 h-6"
        fill="none"
  ...
  },
  {
    title: 'Batch Numbers',
    description:
      'Always double-check batch numbers before submitting to avoid errors.',
    icon: (
      <svg
        className="w-6 h-6"
        fill="none"
  ...
  },
  {
    title: 'Quality First',
    description:
      'Take your time to ensure accuracy. Quality is more important than speed.',
    icon: (
      <svg
        className="w-6 h-6"
        fill="none"
  ...
  },
  {
    ...
    description:
      'Press Tab to move between fields quickly without using your mouse.',
    icon: (
      <svg
        className="w-6 h-6"
        fill="none"
