...
// Admin components
import { SystemHealthWidget, QuickActionsPanel, UserActivityChart, AlertsPanel, SystemStatisticsCards } from './admin'

// Manager components
import { ExecutiveSummaryCards, AnalyticsOverview, ReportsCenter, TeamPerformance } from './manager'

// Supervisor components
import { ItemsRequiringReview, TeamActivityMonitor, QualityControlDashboard, RecentEntriesTable, AuditHighlights } from './supervisor'

// Data Entry components
import { AddNewItemCard, TodaysEntries, PersonalStats, RecentBatches, TipsWidget } from './data-entry'

// Auditor components
import { AdvancedSearchBar, AuditOverview, ActivityHeatmap, UserBehaviorAnalysis } from './auditor'
