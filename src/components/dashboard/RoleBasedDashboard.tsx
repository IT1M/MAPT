      ...
      <div className="space-y-6">
        ...
        <div className="bg-accent-50 dark:bg-accent-900/20 border border-accent-200 dark:border-accent-800 rounded-lg p-4">
          <div className="flex items-start gap-3">
            <svg
              className="w-5 h-5 text-accent-600 dark:text-accent-400 mt-0.5"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
            ...
            <div>
              ...
              <p className="text-sm text-accent-700 dark:text-accent-300 mt-1">
                Access comprehensive reports and analytics to make informed
                decisions. Generate custom reports from the Reports section.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-purple-700 dark:text-purple-300 mt-1">
                You have full access to audit logs and system activity. Review
                recent changes in the Audit section.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-primary-700 dark:text-primary-300 mt-1">
                Use keyboard shortcuts to speed up data entry. Press{' '}
                <kbd className="px-2 py-1 bg-white dark:bg-gray-800 rounded border border-primary-300 dark:border-primary-700 text-xs">
                  Ctrl+N
                </kbd>{' '}
