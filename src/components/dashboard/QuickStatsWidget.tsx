...
export const QuickStatsWidget = React.memo<QuickStatsWidgetProps>(function QuickStatsWidget({
  todayCount,
  recentEntries,
  onRefresh,
}) {
      ...
      <Card className="sticky top-4">
        ...
        <Card.Body className="space-y-6">
          ...
          <section aria-labelledby="today-count-heading">
            <h3 id="today-count-heading" className="text-sm text-gray-600 dark:text-gray-400 mb-1">
              Today&apos;s Entries
            </h3>
            <p className="text-3xl font-bold text-primary-600 dark:text-primary-400" aria-live="polite">
              {todayCount}
            </p>
          </section>
          ...
          <section aria-labelledby="destinations-heading">
            <h3 id="destinations-heading" className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
              Destinations
            </h3>
          ...
          <section aria-labelledby="recent-items-heading">
            <h3 id="recent-items-heading" className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
              Recent Items
            </h3>
