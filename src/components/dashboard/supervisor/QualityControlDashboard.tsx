  ...
  if (!metrics) {
    return (
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
        <p className="text-gray-500 dark:text-gray-400">Failed to load quality metrics</p>
      </div>
    )
  }
    ...
    <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
        <div className="border border-gray-200 dark:border-gray-700 rounded-lg p-4">
          ...
          <p className={`text-3xl font-bold ${getRejectRateColor(metrics.overallRejectRate)}`}>
      ...
      <div>
        ...
        <div className="space-y-2">
          {metrics.topIssues.length === 0 ? (
            <p className="text-gray-500 dark:text-gray-400 text-sm">No issues reported</p>
          ) : (
