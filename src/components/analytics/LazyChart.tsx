...
const InventoryTrendChart = lazy(() =>
  import('./charts/InventoryTrendChart').then((mod) => ({
    default: mod.InventoryTrendChart,
  }))
);

const DestinationChart = lazy(() =>
  import('./charts/DestinationChart').then((mod) => ({
    default: mod.DestinationChart,
  }))
);

const CategoryChart = lazy(() =>
  import('./charts/CategoryChart').then((mod) => ({
    default: mod.CategoryChart,
  }))
);

const RejectAnalysisChart = lazy(() =>
  import('./charts/RejectAnalysisChart').then((mod) => ({
    default: mod.RejectAnalysisChart,
  }))
);

const UserActivityHeatmap = lazy(() =>
  import('./charts/UserActivityHeatmap').then((mod) => ({
    default: mod.UserActivityHeatmap,
  }))
);

const MonthlyComparisonChart = lazy(() =>
  import('./charts/MonthlyComparisonChart').then((mod) => ({
    default: mod.MonthlyComparisonChart,
  }))
);
