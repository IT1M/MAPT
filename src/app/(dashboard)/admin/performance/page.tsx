  ...
  const fetchData = async (forceRefresh = false) => {
    try {
      ...
      const metricsRes = await fetch(
        `/api/performance/metrics?minutes=${timeRange}`
      );
      if (!metricsRes.ok) {
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 mt-1">
            Real-time system performance metrics and AI-powered optimization
            recommendations
          </p>
        </div>
        ...
        <>
          ...
          {recommendationsData.analysis.criticalIssues.length > 0 && (
            <div className="bg-red-50 border-2 border-red-200 rounded-lg p-6">
              ...
              <ul className="space-y-2">
                {recommendationsData.analysis.criticalIssues.map(
                  (issue, index) => (
                    <li
                      key={index}
          ...
          <div className="bg-blue-50 border-2 border-blue-200 rounded-lg p-6">
            ...
            <p className="text-blue-800">
              {recommendationsData.analysis.summary}
            </p>
              ...
              <div className="mt-4">
                <div className="flex items-center justify-between text-sm mb-2">
                  ...
                  <span className="font-semibold text-blue-900">
                    {recommendationsData.progress.implemented} /{' '}
                    {recommendationsData.progress.total} (
                ...
                <div className="w-full bg-blue-200 rounded-full h-2">
                  <div
                    ...
                    style={{
                      width: `${recommendationsData.progress.percentage}%`,
                    }}
                  />
                </div>
              </div>
