...
export default function AuditPage() {
  ...
  const renderChanges = (changes: any) => {
    if (!changes) return <p className="text-gray-500 dark:text-gray-400">No changes recorded</p>
                  ...
                  {logs.map((log) => (
                    <tr key={log.id} className="hover:bg-gray-50 dark:hover:bg-gray-700">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-400">
                        {t(`audit.entities.${log.entity}` as any) || log.entity}
                      </td>
          ...
          <div className="space-y-4">
            <div className="grid grid-cols-2 gap-4 pb-4 border-b border-gray-200 dark:border-gray-700">
              ...
              <div>
                ...
                <p className="font-medium text-gray-900 dark:text-gray-100">{formatDate(selectedLog.createdAt)}</p>
              </div>
              <div>
              ...
              <div>
                ...
                <p className="font-medium text-gray-900 dark:text-gray-100">
                  {t(`audit.entities.${selectedLog.entity}` as any) || selectedLog.entity}
                </p>
              </div>
            </div>
