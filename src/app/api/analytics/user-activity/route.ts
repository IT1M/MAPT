...
import { successResponse, handleApiError, insufficientPermissionsError } from '@/utils/api-response'
...
export async function GET(request: NextRequest) {
  try {
    ...
    if (context.user.role !== 'ADMIN' && context.user.role !== 'SUPERVISOR') {
      return insufficientPermissionsError('This endpoint is restricted to ADMIN and SUPERVISOR roles')
    }
