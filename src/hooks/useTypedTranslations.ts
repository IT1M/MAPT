 ...
 */
export function useTypedTranslations<T extends TranslationNamespace>(
  namespace: T
) {
...
export function useCommonTranslations() {
  return useTranslations('common') as (
...
export function useNavigationTranslations() {
  return useTranslations('navigation') as (
    key: keyof NavigationTranslations,
    params?: TranslationParams
  ) => string;
}
...
export function useAuthTranslations() {
  return useTranslations('auth') as (
    key: keyof AuthTranslations,
    params?: TranslationParams
  ) => string;
}
...
export function useDashboardTranslations() {
  return useTranslations('dashboard') as (
    key: keyof DashboardTranslations,
    params?: TranslationParams
  ) => string;
}
...
export function useReportsTranslations() {
  return useTranslations('reports') as (
    key: keyof ReportsTranslations,
    params?: TranslationParams
  ) => string;
}
...
export function useInventoryTranslations() {
  return useTranslations('inventory') as (
    key: keyof InventoryTranslations,
    params?: TranslationParams
  ) => string;
}
...
export function useFormsTranslations() {
  return useTranslations('forms') as (
    key: keyof FormsTranslations,
    params?: TranslationParams
  ) => string;
}
...
export function useErrorsTranslations() {
  return useTranslations('errors') as (
    key: keyof ErrorsTranslations,
    params?: TranslationParams
  ) => string;
}
...
export function useSettingsTranslations() {
  return useTranslations('settings') as (
    key: keyof SettingsTranslations,
    params?: TranslationParams
  ) => string;
}
...
export function useDataLogTranslations() {
  return useTranslations('dataLog') as (
    key: keyof DataLogTranslations,
    params?: TranslationParams
  ) => string;
}
...
export function useAnalyticsTranslations() {
  return useTranslations('analytics') as (
    key: keyof AnalyticsTranslations,
    params?: TranslationParams
  ) => string;
}
...
export function useBackupTranslations() {
  return useTranslations('backup') as (
    key: keyof BackupTranslations,
    params?: TranslationParams
  ) => string;
}
...
export function useDataEntryTranslations() {
  return useTranslations('dataEntry') as (
    key: keyof DataEntryTranslations,
    params?: TranslationParams
  ) => string;
}
...
export function useAuditTranslations() {
  return useTranslations('audit') as (
    key: keyof AuditTranslations,
    params?: TranslationParams
  ) => string;
}
