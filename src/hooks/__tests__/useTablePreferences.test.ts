...
describe('useTablePreferences', () => {
  ...
  it('toggles column visibility', () => {
    ...
    expect(result.current.preferences.columnVisibility.batch).toBe(!initialVisibility)
  ...
  it('loads preferences from localStorage', () => {
    ...
    localStorageMock.setItem('dataLog.tablePreferences', JSON.stringify(preferences))
