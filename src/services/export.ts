...
export async function logExport(params: {
  ...
  const { userId, format, recordCount, fileSize, filters, entity, entityId } = params
 ...
 */
export function shouldEmailExport(recordCount: number, threshold: number = 5000): boolean {
