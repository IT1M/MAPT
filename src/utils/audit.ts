  ...
  try {
    const auditLog = await prisma.auditLog.create({
      data: {
        ...
        entityType: entity,
        entityId,
        oldValue: changes?.oldValue ? (changes.oldValue as Prisma.InputJsonValue) : undefined,
        newValue: changes?.newValue ? (changes.newValue as Prisma.InputJsonValue) : undefined,
